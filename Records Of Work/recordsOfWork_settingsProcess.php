...
if (!isActionAccessible($guid, $connection2, '/modules/Records Of Work/recordsOfWork_settings.php')) {
    ...
    $URL .= '/recordsOfWork_settings.php';

    $settingManager = getSettings($container);
    $return = $settingManager->process($_POST);

    $logGateway = $container->get(LogGateway::class);
    $logGateway->addLog($session->get('gibbonSchoolYearID'), 'Records Of Work', $session->get('gibbonPersonID'), 'Records Of Work Settings Edited');
