...
INSERT INTO `schoolQA` (`gibbonPersonID`, `groupID`) VALUES ((SELECT `gibbonPersonID` FROM `gibbonPerson` WHERE `username`='testingheadtech' LIMIT 1), '0001') ON DUPLICATE KEY UPDATE `groupID`='0001';
...
INSERT INTO `schoolQA` (`gibbonPersonID`, `groupID`) VALUES ((SELECT `gibbonPersonID` FROM `gibbonPerson` WHERE `username`='testingtech' LIMIT 1), '0002') ON DUPLICATE KEY UPDATE `groupID`='0002';
