...
if (!isActionAccessible($guid, $connection2, '/modules/Records Of Work/recordsOfWork_manageTechnicians.php')) {
    ...
    //Proceed!
    $page->return->setEditLink($session->get('absoluteURL') . '/index.php?q=/modules/' . $session->get('module') . '/recordsOfWork_manageTechnicians.php');
    ...
    $form = Form::create('createTechnician',  $session->get('absoluteURL') . '/modules/' . $session->get('module') . '/recordsOfWork_createTechnicianProcess.php', 'post');
