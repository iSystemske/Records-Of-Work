...
if (!isActionAccessible($guid, $connection2, '/modules/Records Of Work/recordsOfWork_manageTechnicians.php')) {
    ...
    if ($technician->isEmpty()) {
        ...
        $form->addHiddenValue('q', '/modules/' . $session->get('module') . '/recordsOfWork_technicianStats.php');
        $form->addHiddenValue('qualityassuaranceID', $qualityassuaranceID);
        ...
        $logCriteria = $logGateway->newQueryCriteria(false)
            ...
            ->filterBy('array', serialize(['qualityassuaranceID' => $qualityassuaranceID]))
