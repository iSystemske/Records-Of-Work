...
if (empty($session->get('gibbonPersonID')) || empty($session->get('gibbonRoleIDPrimary'))
    || !isActionAccessible($guid, $connection2, '/modules/Records Of Work/recordsOfWork_manageTechnicianGroup.php')) {
    ...
    $sql = 'SELECT COUNT(*) FROM qualityAssuaranceGroups WHERE groupName=:groupName';
